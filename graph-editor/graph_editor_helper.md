...
| `dependencies` | Almost everything | (a) Parent nodes: must list every child (`validate_graph.py` check 4). (b) Leaf nodes: drives "wired" dummy-call generation in both generators, and cross-language boundary checks. |
